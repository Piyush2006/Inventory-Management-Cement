...
CREATE TABLE "new_StockRequest" (
    ...
    CONSTRAINT "StockRequest_toLocationId_fkey" FOREIGN KEY ("toLocationId") REFERENCES "Location" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_StockRequest" ("acceptedAt", "acceptedByUserId", "assignedAt", "assignedByUserId", "assignedToUserId", "completedAt", "createdAt", "deliveredAt", "deliveredByUserId", "deliveredQuantity", "deliveryNote", "equipmentRef", "fromLocationId", "id", "materialId", "notReceivedAt", "notReceivedReason", "note", "priority", "quantityRequested", "reason", "receivedQuantity", "rejectedAt", "rejectedByUserId", "rejectionReason", "requestNumber", "requestType", "requestedByRole", "requestedByUserId", "requiredByDate", "routedAt", "routedByUserId", "routedToUserId", "status", "toLocationId", "updatedAt") SELECT "acceptedAt", "acceptedByUserId", "assignedAt", "assignedByUserId", "assignedToUserId", "completedAt", "createdAt", "deliveredAt", "deliveredByUserId", "deliveredQuantity", "deliveryNote", "equipmentRef", "fromLocationId", "id", "materialId", "notReceivedAt", "notReceivedReason", "note", "priority", "quantityRequested", "reason", "receivedQuantity", "rejectedAt", "rejectedByUserId", "rejectionReason", "requestNumber", "requestType", "requestedByRole", "requestedByUserId", "requiredByDate", "routedAt", "routedByUserId", "routedToUserId", "status", "toLocationId", "updatedAt" FROM "StockRequest";

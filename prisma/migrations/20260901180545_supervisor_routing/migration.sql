...
INSERT INTO "new_StockRequest" ("acceptedAt", "acceptedByUserId", "assignedAt", "assignedByUserId", "assignedToUserId", "completedAt", "createdAt", "deliveredAt", "deliveredByUserId", "deliveredQuantity", "deliveryNote", "fromLocationId", "id", "materialId", "notReceivedAt", "notReceivedReason", "note", "priority", "quantityRequested", "reason", "receivedQuantity", "rejectedAt", "rejectedByUserId", "rejectionReason", "requestNumber", "requestedByRole", "requestedByUserId", "requiredByDate", "status", "toLocationId", "updatedAt") SELECT "acceptedAt", "acceptedByUserId", "assignedAt", "assignedByUserId", "assignedToUserId", "completedAt", "createdAt", "deliveredAt", "deliveredByUserId", "deliveredQuantity", "deliveryNote", "fromLocationId", "id", "materialId", "notReceivedAt", "notReceivedReason", "note", "priority", "quantityRequested", "reason", "receivedQuantity", "rejectedAt", "rejectedByUserId", "rejectionReason", "requestNumber", "requestedByRole", "requestedByUserId", "requiredByDate", "status", "toLocationId", "updatedAt" FROM "StockRequest";
